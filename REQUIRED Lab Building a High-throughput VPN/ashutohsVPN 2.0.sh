...
echo "${CYAN_TEXT}${BOLD_TEXT}      SUBSCRIBE Monarch of nwo- INITIATING EXECUTION...  ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${CYAN_TEXT}${BOLD_TEXT}=======================================================${RESET_FORMAT_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@ashumhatre${RESET_FORMAT_FORMAT}"
echo "${GREEN_TEXT}${BOLD_TEXT}I AM ASHUTOSH THE MONARCH OF NEW WORLD ORDER${RESET_FORMAT_FORMAT}"
echo
